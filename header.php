    ...
    <div id="wrapper" class="hfeed">
                ...
                <div class="header-content">
                    ...
                    <div class="logo">
                        <?php if (has_custom_logo()) {
                            ...
                            $logo_2 = get_theme_mod('custom_logo_2');
                        }
                        ?>
                        <img src="<?php echo esc_url($logo_url); ?>" alt="Logo" class="default-logo">
                        <img src="<?php echo esc_url($logo_2); ?>" alt="Secondary Logo" class="scroll-logo">
        ...
        <div id="container">
            ...
            <main id="content" role="main">
                ...
                <a href="#" class="toTop">
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="70" height="70" x="0" y="0" viewBox="0 0 24 24" style="enable-background:new 0 0 512 512" xml:space="preserve" fill-rule="evenodd" class="hovered-paths">
                        <g>
                            <path d="m12 9.414-6.293 6.293a1 1 0 0 1-1.414-1.414l7-7a.999.999 0 0 1 1.414 0l7 7a1 1 0 0 1-1.414 1.414z" fill="#ffffff" opacity="1" data-original="#000000" class="hovered-path"></path>
                        </g>
                    </svg>
                </a>
                ...
                <div class="social-media">
                    <a class="social-icon" href=<?php echo esc_url(get_theme_mod('facebook_link')); ?>>
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="40" height="40" x="0" y="0" viewBox="0 0 60 60" style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                            <g>
                                <path d="M22.316 12.234v7.985h-5.85v9.766h5.85V59h12.021V29.985H42.4s.754-4.684 1.121-9.803H34.38v-6.677c0-.997 1.309-2.34 2.605-2.34h6.547V.999h-8.9C22.02 1 22.316 10.774 22.316 12.234z" style="stroke-width:1.5;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10" fill="none" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="1" data-original="#231f20" opacity="1" class=""></path>
                            </g>
                        </svg>
                    </a>
                    <a class="social-icon" href=<?php echo esc_url(get_theme_mod('instagram_link')); ?>>
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="40" height="40" x="0" y="0" viewBox="0 0 256 256" style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                            <g>
                                <path d="M188.385 248.941H67.615a60.626 60.626 0 0 1-60.558-60.556V67.615A60.626 60.626 0 0 1 67.615 7.06h120.77a60.626 60.626 0 0 1 60.558 60.556v120.77a60.626 60.626 0 0 1-60.558 60.556zM67.615 17.1A50.573 50.573 0 0 0 17.1 67.615v120.77A50.573 50.573 0 0 0 67.615 238.9h120.77a50.573 50.573 0 0 0 50.516-50.516V67.615A50.573 50.573 0 0 0 188.385 17.1z" fill="#ffffff" opacity="1" data-original="#000000" class=""></path>
                                <path d="M128 189.846a61.846 61.846 0 1 1 61.846-61.847A61.916 61.916 0 0 1 128 189.846zm0-113.65a51.805 51.805 0 1 0 51.804 51.803A51.862 51.862 0 0 0 128 76.195zM192.088 76.016a18.004 18.004 0 1 1 18.005-18.004 18.025 18.025 0 0 1-18.005 18.004zm0-25.968a7.963 7.963 0 1 0 7.963 7.964 7.973 7.973 0 0 0-7.963-7.964z" fill="#ffffff" opacity="1" data-original="#000000" class=""></path>
                            </g>
                        </svg> </a>
